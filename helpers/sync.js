...
export const syncPrismic = async (currentPage = null) => {
  if(!currentPage) await elasticSearchClient().deleteByQuery({ // TODO: deleteByQuery without an explicit query is deprecated on ES 6+. Use _doc feature of ES 7 when VSF 1.11.0 gets released
